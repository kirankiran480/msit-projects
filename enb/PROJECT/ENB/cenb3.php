...
<table width="1280">
    ...
    <form method="post" action="cenb3db.php">
        <table id="dataTable" border="1" width="400">
            <tr>
             ...
             <tr>
            <td><textarea  name="context[]" size="35" rows="5" style="height: 100px;width:450;">  </textarea></td>
            <td><textarea  name="lesson[]" size="35" rows="5" style="height: 100px;width:450;">  </textarea></td>
