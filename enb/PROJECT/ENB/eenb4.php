...
<table width="1280">
    ...
    <form method="post" action="editenbdb4.php">
        <table id="dataTable" border="1" width="400">
            <tr>
                <td>deliverable</td>
                <td>What plan you intend to accomplish and why</td>
            </tr>
             <?php
 while($row=mysqli_fetch_array($result))
 {
    $context=$row["deliverable"];
    $lesson=$row["what"];
    ?>
     <tr>
         <!--<td><input type="text" value=></td>-->
         <td><input type="text" name="deliverable[]" value=<?php echo $context;?>></td>
         <td><input type="text" name="what[]" value=<?php echo $lesson;?>></td>
     </tr>
 <?php    
 }?>
        </table>
