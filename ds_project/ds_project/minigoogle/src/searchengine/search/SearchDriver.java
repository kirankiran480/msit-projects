...
public class SearchDriver
{
	...
	if(args.length<3)
	 ...
	 public static String mainclient(String arg)
		...
		if(args.length<3)
			...
			//System.out.println("jjjjjjj"+args[2]+args[3]+args[4]+args[1]);
			String str = sd.Search(args[2],args[3],args[4],args[1]);
	...
	public Vector<String> Url()
	{
		...
		public String Search(String str1,String str2,String str3,String str4)
		{
			...
			try
			{
			    FileInputStream indexSource=new FileInputStream("kiran.txt");
			    w.restore(indexSource);
			}
			catch(IOException e)
			{
			...
			for(int l=0;l<v.size();l++)
			{
				...
				i = (ObjectIterator<String>) w.retrievePages(dat);
				res_arr[l] = Url();
